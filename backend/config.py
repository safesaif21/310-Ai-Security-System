...
class Settings(BaseSettings):
    ...
    recording_size_limit_gb: float = Field(default=1.0, alias="RECORDING_SIZE_LIMIT_GB")
    ...
    recording_rotation_seconds: int = Field(default=60, alias="RECORDING_ROTATION_SECONDS")
